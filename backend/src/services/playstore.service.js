...
//         withTimeout(gplay.suggest({ term, country: country || 'us' }), REQUEST_TIMEOUT_MS)
//       );
...
//   try {
//     const data = await withLimit(() =>
//       withTimeout(gplay.search({ term, country: country || 'us', num: 5 }), REQUEST_TIMEOUT_MS)
//     );
...
//   try {
//     const data = await withLimit(() =>
//       withTimeout(gplay.app({ appId, country: country || 'us' }), REQUEST_TIMEOUT_MS)
//     );
